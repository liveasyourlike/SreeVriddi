    ...
    <header className="sticky top-0 z-50 bg-slate-950/90 backdrop-blur-md border-b border-amber-500/20 shadow-2xl">
      ...
      <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-8 py-2.5 sm:py-3 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group min-w-0">
          ...
          <div className="hidden sm:block min-w-0"><div className="font-serif-brand text-lg sm:text-xl font-bold tracking-[.14em] text-white">Sree <span className="text-amber-400">Vriddhi</span></div><p className="text-[9px] text-amber-200/80 tracking-widest uppercase font-medium truncate">{brandSettings.tagline}</p></div>
        </Link>
