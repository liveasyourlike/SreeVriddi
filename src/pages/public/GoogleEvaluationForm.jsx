    ...
    <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10">
      <div className="rounded-2xl border border-amber-500/25 bg-slate-950/80 p-5 sm:p-7 shadow-xl">
        ...
        <div className="mt-6 rounded-2xl border border-slate-800 bg-slate-900/50 p-4 sm:p-5">
          <div className="mb-4 flex items-start justify-between gap-3"><div><p className="text-[10px] font-extrabold uppercase tracking-[.18em] text-amber-300">Step 1 · Choose a category</p><h2 className="mt-1 text-lg sm:text-xl font-extrabold text-white">What best matches your requirement?</h2><p className="mt-1 text-[11px] leading-5 text-slate-400">This on-site selection is for orientation only. The official Google Form remains the source of truth for submission.</p></div><span className="hidden sm:inline-flex rounded-full border border-emerald-500/20 bg-emerald-500/5 px-2.5 py-1 text-[9px] font-bold text-emerald-300">Interactive preview</span></div>
